    ...
    $.fn.extend($, {
        ...
        dpm: function (res) {
            ...
            if (isString (res)) {
                ...
                resource = res;
                resourceUrl = lastRequest.hasOwnProperty('url') ? lastRequest.url : '/';
            }
            ...
            var Api = function() {
                ...
                this.propFind = function(cob) {
                    ...
                    extendBeforeSend(cob, function (xhr) {
                        ...
                        //xhr.setRequestHeader ('Authorization', 'Basic juanmvcalvellido:valencia');
                    });
                ...
                this.propPatch = function(cob) {
                    ...
                    cob.setProperty = cob.setProperty ? isArray(cob.setProperty) ? cob.setProperty : [cob.setProperty] : [];
                    cob.removeProperty = cob.removeProperty ? isArray(cob.removeProperty) ? cob.removeProperty : [cob.removeProperty] : [];
                ...
                this.setProperty = function(cob) {
                    if (cob.property) { //Only works if sent a property
